...
echo "=== UPLOAD FILES WITH EXPLICIT PATHS ===\n";
...
echo "\n=== UPLOADING FILES WITH EXPLICIT PATHS ===\n";

// Upload files with explicit paths
$uploads = [
...
foreach ($uploads as $filename => $folder) {
    ...
    if (file_exists($filePath)) {
        try {
            ...
            $uploadedPath = Storage::disk('s3')->putFileAs($folder, $filePath, $explicitFilename);
...
if ($savedFiles > 0) {
    ...
    echo "🔍 Check your S3 bucket manually to see the uploaded files\n";
    echo "📁 Files should be in these folders:\n";
...
echo "\n=== NEXT STEPS ===\n";
echo "1. Check your S3 bucket manually to see the uploaded files\n";
