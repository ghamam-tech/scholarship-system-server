...
echo "\n=== UPLOADING FILES WITH MANUAL PATHS ===\n";

// Upload files with manual path construction
$uploads = [
...
foreach ($uploads as $filename => $folder) {
    ...
    if (file_exists($filePath)) {
        try {
            ...
            // Manually construct the path since Laravel isn't returning it
...
echo "\n=== UPDATING DATABASE WITH MANUAL PATHS ===\n";
